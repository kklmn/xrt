...
allArguments = ['bl', 'name', 'center', 'bragg', 'pitch', 'roll', 'yaw',
                ...
                'surface', 'curSurface', 'material', 'material2', 'alpha',
                'jack1', 'jack2', 'jack3', 'tx1', 'tx2', 'dx',
                ...
                'crossSection', 'Rs', 'R', 'r', 'r1', 'r2',
                'xCylinder1', 'hCylinder1', 'xCylinder2', 'hCylinder2',
                'p', 'q', 'isCylindrical',
                'isClosed', 'L0', 'theta', 'r0', 'ellipseA', 'ellipseB',
                'workingDistance', 'wedgeAngle', 'RmBragg', 'RsBragg',
